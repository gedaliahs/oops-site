class Oops < Formula
  ...
  homepage "https://oops-gedaliahs.vercel.app"
  version "0.1.0"
  license "MIT"

  on_macos do
    if Hardware::CPU.arm?
      url "https://oops-gedaliahs.vercel.app/releases/oops_darwin_arm64.tar.gz"
      sha256 "c42817f6f556fa26fa60f2f875eb2dc9c4f1dc5bc9efdf6b53c0c021aed75c6a"
    else
      url "https://oops-gedaliahs.vercel.app/releases/oops_darwin_amd64.tar.gz"
  ...
  on_linux do
    if Hardware::CPU.arm?
      url "https://oops-gedaliahs.vercel.app/releases/oops_linux_arm64.tar.gz"
      sha256 "dc07c92bfdee7d8d00d707e43f509cdd10f46c9774ffd66364b603011ad3d13b"
    else
      url "https://oops-gedaliahs.vercel.app/releases/oops_linux_amd64.tar.gz"
